...
// void Hybrid_astar_class::draw_start_goal_on_map()
// {
...
// void Hybrid_astar_class::draw_arc(std::array<float, 3> node_pose, std::array<float, 3> next_pose, int radius, float arc_angle, int motion_type, int thickness, cv::Scalar color)
// {
