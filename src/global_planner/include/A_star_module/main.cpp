...
int main()
{
    ...
    std::string img_path = "willow-full.pgm";
    ...
    startnode[0] = 315;  // start position, x
    startnode[1] = 200;  // start position, x
    goalnode[0] = 215;  // start position, x
    goalnode[1] = 460;  // start position, x
